...
const Index = () => {
    ...
    return ( <
            ...
            <
            meta name = "viewport"
            content = "width=650, initial-scale=1" / >
            <
            meta itemprop = "name"
            content = "WAIT: What Anime Is This?" / >
            <
            ...
            <
            meta itemprop = "image"
            content = "https://trace.moe/favicon128.png" / >
            ...
            href = { NEXT_PUBLIC_API_ENDPOINT }
            /> < /
            Head > { /* inject target for WebExtension */ } <
            ...
            <
            div className = { searchImageSrc ? mainReady : main } > {!searchImageSrc && ( <
            ...
            SearchBar searchImageSrc = { searchImageSrc }
            imageURL = { imageURL }
...

            {
                searchImageSrc && ( <
                    ...
                    img className = { originalImageDisplay }
                    src = { searchImageSrc }
                    ...
                    div > {
                        ...
                        searchResult.find((e) => e.anilist.isAdult) && ( <
                            ...
                            } > { showNSFW ? "Hide" : "Show" } { " " } { searchResult.filter((e) => e.anilist.isAdult).length }
                            NSFW results <
                            /button> < /
                            div >
                        )
